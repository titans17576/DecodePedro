...
public class TeleopRed extends OpMode {
    ...
    private double distanceFromRedGoal = 0;
    ...
    public void loop() {
        ...
        /*if (distanceFromRedGoal) >= 96) { //need to make toggle? was 96
            IntakeFSM.highIntakeOn_velocity = 1100; //slower transfer speed means less bounce outs due to artifact contact
        } else if (distanceFromRedGoal) < 96){
            IntakeFSM.highIntakeOn_velocity = 1600;
        }*/

        if (distanceFromRedGoal <= 60) {
            lookupValue = 1160;
            //kP = 0.007;
        } else if ((distanceFromRedGoal > 60) && (distanceFromRedGoal <= 72)) {
            lookupValue = 1190;
            kP = 0.007;
        } else if ((distanceFromRedGoal > 72) && (distanceFromRedGoal <= 84)) {
            lookupValue = 1220;
            kP = 0.007;
        } else if ((distanceFromRedGoal > 84) && (distanceFromRedGoal <= 96)) {
            lookupValue = 1240;
            kP = 0.007;
        } else if ((distanceFromRedGoal > 96) && (distanceFromRedGoal <= 108)) {
            lookupValue = 1270;
        } else if ((distanceFromRedGoal > 108) && (distanceFromRedGoal <= 120)) {
            lookupValue = 1300;
        } else if ((distanceFromRedGoal > 120) && (distanceFromRedGoal <= 132)) {
            lookupValue = 1340;
        } else if ((distanceFromRedGoal > 132) && (distanceFromRedGoal <= 144)) {
            lookupValue = 1380;
        } else if ((distanceFromRedGoal > 144) && (distanceFromRedGoal <= 156)) {
            lookupValue = 1420;
        } else if ((distanceFromRedGoal > 156) && (distanceFromRedGoal <= 168)) {
            lookupValue = 1460;
        } else if ((distanceFromRedGoal > 168) && (distanceFromRedGoal <= 180)) {
            lookupValue = 1500;
        } else if (distanceFromRedGoal > 180) {
            lookupValue = 1540;
        }
        ...
        */
        ...
        telemetry.addData("distanceFromRedGoal", distanceFromRedGoal);
