...
/**
 * This is the LateralZeroPowerAccelerationTuner autonomous follower OpMode. This runs the util.robot
 * to the right until a specified velocity is achieved. Then, the util.robot cuts power to the motors, setting
...
public class LateralZeroPowerAccelerationTuner extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("The util.robot will run to the right until it reaches " + VELOCITY + " inches per second.");
