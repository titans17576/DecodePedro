...
/**
 * This is the ForwardVelocityTuner autonomous follower OpMode. This runs the util.robot forwards at max
...
public class ForwardVelocityTuner extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("The util.robot will run at 1 power until it reaches " + DISTANCE + " inches forward.");
        telemetryA.addLine("Make sure you have enough room, since the util.robot has inertia after cutting power.");
        telemetryA.addLine("After running the distance, the util.robot will cut power from the drivetrain and display the forward velocity.");
     ...
     * velocities, and when the util.robot has run forward enough, these last velocities recorded are
