...
/**
 * This is the ForwardTuner OpMode. This tracks the forward movement of the util.robot and displays the
...
public class ForwardTuner extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("Pull your util.robot forward " + DISTANCE + " inches. Your forward ticks to inches will be shown on the telemetry.");
        telemetryA.update();
