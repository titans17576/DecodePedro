...
/**
 * This is the CurvedBackAndForth autonomous OpMode. It runs the util.robot in a specified distance
 * forward and to the left. On reaching the end of the forward Path, the util.robot runs the backward
...
public class CurvedBackAndForth extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("This will run the util.robot in a curve going " + DISTANCE + " inches"
                            + " to the left and the same number of inches forward. The util.robot will go"
