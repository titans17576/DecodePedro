...
Sensor:    	This is a Sample OpMode that shows how to use a specific sensor.
            It is not intended to drive a functioning util.robot, it is simply showing the minimal code
...
Concept:	This is a sample OpMode that illustrates performing a specific function or concept.
            ...
            locate based on their name.  These OpModes may not produce a drivable util.robot.

Utility:    This sample type is provided as a useful tool, or aide, to perform some specific development task.
            It is not expected to be something you would include in your own util.robot code.
...
Special programming methods, or util.robot control techniques should be reserved for “Concept” Samples,
